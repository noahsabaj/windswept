...
LANGUAGE = {
	...
	spawnAdded = "Point d'apparition ajouté (%s au total).",
	...
	contentTitle = "Contenu Windswept manquant",
	contentWarning = "Le contenu d'Windswept n'est pas monté. Certaines fonctionnalités peuvent être manquantes.\nSouhaitez-vous ouvrir la page du Workshop pour le contenu Windswept ?",
	flags = "Flags",
	...
	optdShowIntro = "Affiche l'introduction de Windswept la prochaine fois que vous vous inscrivez. Ceci est toujours désactivé après l'avoir regardé.",
	...
	optdThirdpersonEnabled = "Déplace la caméra derrière toi. Ceci peut également être activé dans la console avec la commande \"ws_togglethirdperson\"",
	...
	optLanguage = "Langue",
	optdLanguage = "La langue affichée dans l'interface utilisateur Windswept.",
	...
	cmdSpawnAdd = "Ajoute un point d'apparition à votre position actuelle.",
