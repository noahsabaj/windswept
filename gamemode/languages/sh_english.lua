...
LANGUAGE = {
	...
	dAddedFaction = "Added %s to this door.",
	dRemovedFaction = "Removed %s from this door.",
	dClearedFactions = "Removed all factions from this door.",
	dFactionAlreadyAdded = "This faction already has access to this door.",
	dFactionNotOnDoor = "This faction does not have access to this door.",
	...
	cChangeFactionNone = "%s has removed %s from their faction.",
	...
	optdShowIntro = "Shows the Windswept introduction the next time you join. This is always disabled after you've watched it.",
	...
	optdThirdpersonEnabled = "Moves the camera behind you. This can also be enabled with the \"ws_togglethirdperson\" console command.",
	...
	optdLanguage = "The language shown in the Windswept UI.",
	...
	classSwitched = "You are now part of the %s class.",
	classSwitchFail = "You are unable to switch to that class.",
	...
	cmdDoorAddFaction = "Adds a faction to the door you are looking at.",
	cmdDoorRemoveFaction = "Removes a faction from the door you are looking at.",
	cmdDoorClearFactions = "Removes all factions from the door you are looking at.",
