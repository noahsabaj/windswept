...
LANGUAGE = {
	...
	flagGiveTarget = "You have been given '%s' flags.",
	flagGiveTitle = "Give Flags",
	flagTake = "%s has taken '%s' flags from %s.",
	flagTakeTarget = "Your '%s' flags have been taken.",
	...
	cChangeModelTarget = "Your model has been changed to %s.",
	cChangeName = "%s changed %s's name to %s.",
	cChangeNameTarget = "Your name has been changed to %s.",
	cChangeSkin = "%s changed %s's skin to %s.",
	cChangeSkinTarget = "Your skin has been changed to %s.",
	cChangeGroups = "%s changed %s's \"%s\" bodygroup to %s.",
	cChangeGroupsTarget = "Your \"%s\" bodygroup has been changed to %s.",
	...
	spawnAdded = "Spawn point added (%s total).",
	...
	charKickTarget = "Your character has been kicked.",
	charBan = "%s banned the character %s.",
	charBanTarget = "Your character has been banned.",
	...
	charUnBanTarget = "Your character has been unbanned.",
	...
	cmdSpawnAdd = "Adds a spawn point at your current position.",
