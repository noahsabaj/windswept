...
LANGUAGE = {
    ...
    spawnAdded = "Spawnpunkt hinzugefügt (%s insgesamt).",
    ...
    contentTitle = "Windswept Content fehlt!",
    contentWarning = "Du hast die Windswept-Inhalte nicht installiert. Dies kann dazu führen, dass bestimmte Funktionen fehlen.\nMöchtest du die Workshop-Seite für die Windswept-Inhalte öffnen?",
    ...
    optdShowIntro = "Zeigt die Windswept Einführen beim nächsten Verbinden. Wird nach dem ersten Schauen automatisch deaktiviert.",
    ...
    optdThirdpersonEnabled = "Bewegt die Kamera hinter dich. Kann auch mit dem \"ws_togglethirdperson\" Console-Command umgeschaltet werden.",
    ...
    optLanguage = "Sprache",
    optdLanguage = "Die Sprache der Windswept UI.",
    ...
    cmdSpawnAdd = "Fügt einen Spawnpoint an deiner aktuellen Position hinzu.",
