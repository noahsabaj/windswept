...
LANGUAGE = {
	...
	spawnAdded = "Ponto de ressurgimento adicionado (%s no total).",
	...
	contentTitle = "Faltando Conteúdo do Windswept",
	contentWarning = "Você não tem o conteúdo do Windswept instalado. Isto pode resultar na falta de alguns aspectos.\nVocê gostaria de abrir a página da Workshop para baixar o conteúdo?",
	flags = "Flags",
	...
	optdShowIntro = "Mostra a introdução do Windswept na próxima vez que entrar. Isto é sempre desativado depois que já assiste.",
	...
	optdThirdpersonEnabled = "Move a câmera para atrás de você. Também pode ser ativo com o comando \"ws_togglethirdperson\".",
	...
	optdDisableAnimations = "Desativa as animações do menu do Windswept para transições instantâneas..",
	optAnimationScale = "Escala da Animação",
	optdAnimationScale = "O quão rápido ou devagar as animações devem estar.",
	optLanguage = "Língua",
	optdLanguage = "A língua mostrada na UI do Windswept.",
	...
	cmdSpawnAdd = "Adiciona um ponto de ressurgimento na sua posição atual.",
