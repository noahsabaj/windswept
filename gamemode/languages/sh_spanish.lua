...
LANGUAGE = {
	...
	spawnAdded = "Punto de aparición añadido (%s en total).",
	...
	contentTitle = "Falta el Contenido de Windswept",
	contentWarning = "No tienes el contenido de Windswept montado. Puede que falten ciertas características.\n¿Quieres abrir la página de Workshop del contenido de Windswept?",
	flags = "Flags",
	...
	optdShowIntro = "Muestra la introducción de Windswept la siguiente vez que entres. Esta opción siempre es deshabilitada una vez la has visto.",
	...
	optdThirdpersonEnabled = "Pone la cámara detrás de ti. Esto también puede ser activado con el comando de consola \"ws_togglethirdperson\".",
	...
	optLanguage = "Idioma",
	optdLanguage = "El idioma mostrado en la interfaz de usuario de Windswept.",
	...
	optdEscCloseMenu = "Al pulsar la tecla ESC, se cierra el menú de Windswept y también se oculta automáticamente el menú de pausa de Garry's Mod. Es decir, vuelves directamente a controlar tu personaje.",
	...
	cmdSpawnAdd = "Añade un punto de aparición en tu posición actual.",
